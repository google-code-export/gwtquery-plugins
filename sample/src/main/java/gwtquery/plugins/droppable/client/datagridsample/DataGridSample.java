...
import gwtquery.plugins.droppable.client.datagridsample.ContactDatabase.Category;
import gwtquery.plugins.droppable.client.datagridsample.ContactDatabase.ContactInfo;
...
public class DataGridSample implements EntryPoint {
  ...
  interface DataGridSampleUiBinder extends UiBinder<Widget, DataGridSample> {
  }
  ...
  private static DataGridSampleUiBinder uiBinder = GWT
      .create(DataGridSampleUiBinder.class);

  /**
   * The main DataGrid. Use a {@link DragAndDropDataGrid} instead of a
   * {@link DataGrid}
   */
  @UiField(provided = true)
  DragAndDropDataGrid<ContactInfo> dataGrid;
 ...
 // Attach a column sort handler to the ListDataProvider to sort the list.
  ...
  private void initTableColumns(final SelectionModel<ContactInfo> selectionModel, ListHandler<ContactInfo> sortHandler) {
    ...
    dataGrid
        .addColumn(firstNameColumn, constants.cwDataGridColumnFirstName());
