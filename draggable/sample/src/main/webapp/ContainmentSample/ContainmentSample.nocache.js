function ContainmentSample(){
  ...
  function maybeStartModule(){
    if (scriptsDone && loadDone) {
      ...
      frameWnd.gwtOnLoad(onLoadErrorFunc, 'ContainmentSample', base);
  ...
  function computeScriptBase(){
    var thisScript, markerId = '__gwt_marker_ContainmentSample', markerScript;
  ...
  if (!isHostedMode()) {
    try {
      unflattenKeylistIntoAnswers(['native', 'ie8'], '1B27ED64D24165E4A7B0B0C6A7E157C4');
      unflattenKeylistIntoAnswers(['native', 'safari'], '3002DF7F202CE842026C533A10230654');
      unflattenKeylistIntoAnswers(['js', 'safari'], '33774D9DBDC22496715B97E1BBB0ECE4');
      unflattenKeylistIntoAnswers(['js', 'ie6'], '53202343413FEE90CB785DE97711EE4C');
      unflattenKeylistIntoAnswers(['native', 'gecko'], '576E626FB21B47D9BFC2CBC2119D831A');
      unflattenKeylistIntoAnswers(['js', 'ie8'], '7399BF68C8249AFDA27907B2596AD35A');
      unflattenKeylistIntoAnswers(['js', 'opera'], 'A11ADACC3B758DAB28622962C532C032');
      unflattenKeylistIntoAnswers(['native', 'opera'], 'A619C1DCB0E531CD03021DA944512D37');
      unflattenKeylistIntoAnswers(['js', 'gecko'], 'A9CAC6F696E25017A37602CA588F777B');
      unflattenKeylistIntoAnswers(['native', 'ie6'], 'AE2E2E2E9A0CEBA13720A0FA7FF4FBFF');
      unflattenKeylistIntoAnswers(['native', 'gecko1_8'], 'F1482D7E85CC95A745A66B28C885BA7C');
      unflattenKeylistIntoAnswers(['js', 'gecko1_8'], 'F2A32A89667719BF59AD5226FE13F66F');
