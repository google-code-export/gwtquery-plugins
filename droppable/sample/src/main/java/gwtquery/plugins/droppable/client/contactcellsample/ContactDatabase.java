 ...
 * This majority of the code below comes from the GWT showcase : http://gwt.google.com/samples/Showcase/Showcase.html#!CwCellList
 * 
 */
public class ContactDatabase {
  ...
  /**
   * A contact category.
   *Family", "Friends", "Business", "Others
   */
  public static enum Category {
    OTHERS("Others"), FAMILY("Family"),BUSINESS("Business"),FRIENDS("Friends");
  ...
  static interface DatabaseConstants extends Constants {
	  @DefaultStringArrayValue(value = { "Family", "Friends", "Business", "Others"})
  ...
  public void addContact(ContactInfo contact) {
    List<ContactInfo> contacts = getDataProvider(contact.getCategory()).getList();
  ...
  public void moveContact(ContactInfo contact, Category oldCategory) {
    ...
    List<ContactInfo> newList = getDataProvider(contact.getCategory()).getList();
   ...
   */
  public void addDataDisplay(HasData<ContactInfo> display, Category categorySelected) {
  ...
  public List<ContactInfo> queryContactsByCategory(Category category) {
    ...
    for (ContactInfo contact : dataProviderByCategory.getList()) {
  ...
  public void refreshDisplays() {
    for (ListDataProvider<ContactInfo> list : dataProviderByCategory.values()){
      list.refresh();
    }
  }
