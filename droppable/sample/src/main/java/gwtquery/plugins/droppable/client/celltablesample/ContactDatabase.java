...
/**
 * Code coming from GWT showcase : http://gwt.google.com/samples/Showcase/Showcase.html#!CwCellTable
...
public class ContactDatabase {
  ...
  static interface DatabaseConstants extends Constants {
    @DefaultStringArrayValue(value = { "Family" ,"Friends", "Coworkers", "Businesses", "Contacts"})
