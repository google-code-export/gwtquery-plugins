...
/**
 * AbstractHasData based on revision r9220 
 * http://code.google.com/p/google-web-toolkit/source/browse/trunk/user/src/com/google/gwt/user/cellview/client/AbstractHasData.java?spec=svn9220&r=9220
...
public abstract class AbstractHasData<T> extends Widget implements HasData<T>,
   ...
   */
  public static Element convertToElements(Widget widget,
   ...
   */
  public static void replaceAllChildren(Widget widget, Element childContainer,
      SafeHtml html) {
   ...
   * @param html the HTML to convert
   */
  public static void replaceChildren(Widget widget, Element childContainer,
   ...
   * change. Used by {@link ___CellBrowser} to detect when the displayed data
   * changes.
   *
