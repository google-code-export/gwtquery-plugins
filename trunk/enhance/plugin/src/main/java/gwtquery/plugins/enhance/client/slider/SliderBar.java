...
import gwtquery.plugins.enhance.client.slider.bundles.SliderBarCss;
import gwtquery.plugins.enhance.client.slider.bundles.SliderBarImages;
...
HasValueChangeHandlers<Double> {
  ...
  public SliderBar(double minValue, double maxValue,
    ...
    SliderBarCss.INSTANCE.css().ensureInjected();
