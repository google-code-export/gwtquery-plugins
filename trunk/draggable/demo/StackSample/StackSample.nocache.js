function StackSample(){
  ...
  if (!isHostedMode()) {
    try {
      unflattenKeylistIntoAnswers(['js', 'gecko1_8'], '025B16DEB963F05AA0D5B135C93CBFDD');
      unflattenKeylistIntoAnswers(['native', 'safari'], '0C1D6FF2EF0700027063BB4925B5BF38');
      unflattenKeylistIntoAnswers(['js', 'ie8'], '181853BB1C6C7E97F59379754AAC92F8');
      unflattenKeylistIntoAnswers(['native', 'opera'], '1BAB4214426AF4074673C8B3579AEAE6');
      unflattenKeylistIntoAnswers(['native', 'gecko'], '368628E97D25E568F7DCA995413BECFF');
      unflattenKeylistIntoAnswers(['js', 'safari'], '5688606F615AAC404A15ECD9009FF8A1');
      unflattenKeylistIntoAnswers(['native', 'ie6'], '7BBF6130822623F2EAC0F290B7DCEB1A');
      unflattenKeylistIntoAnswers(['js', 'ie6'], '7EF61E48C4D431E00A40C56A9FC9E55A');
      unflattenKeylistIntoAnswers(['native', 'ie8'], '81439E47C110F538DF9102D72429E584');
      unflattenKeylistIntoAnswers(['js', 'opera'], '845EB40B2A492AFE1CADD0FF084FD597');
      unflattenKeylistIntoAnswers(['native', 'gecko1_8'], '940419049B5CF8CBD0398EE8E9D11043');
      unflattenKeylistIntoAnswers(['js', 'gecko'], 'B76D9E0C3F75643591259F42C620B286');
