...
public class MemberDatabase {
  ...
  public static enum Permission {
    OWNER("Owner",1), COMMITTER("Committer",5),CONTRIBUTOR("Contributor",2),NON_MEMBER("Non-Member",250);
  ...
  public static class MemberInfo implements Comparable<MemberInfo> {
     ...
     */
    public static final ProvidesKey<MemberInfo> KEY_PROVIDER = new ProvidesKey<
    MemberInfo>() {
   ...
   */
  public void addDataDisplay(HasData<MemberInfo> display, Permission selectedPermission) {
  ...
  /**
   * Query all member for the specified permission.
   *
   * @param permission the permission
   * @return the list of members having this permission
   */
  public List<MemberInfo> queryMemberByPermission(Permission permission) {
    return new ArrayList<MemberInfo>(getDataProvider(permission).getList());
  }


  
  /**
   * Refresh displays by permission.
   */
  public void refreshDisplays(Permission p) {
    getDataProvider(p).refresh();
  }
